...
- **Default configuration**: 200 trials, about 85% standard stimuli (800Hz beep tone), 15% target stimuli (1000Hz beep tone)
...
- You can run the experiment on a phone using the Presentation software app.

### Running the Experiment
1. **Setup**:
    - Load the script into the Presentation software.
    - Verify that all required audio files are available in the specified paths.

2. **Start the Experiment**:
    - Run the script. The experiment begins with a decision phase where participants choose whether to include eye movement and rest phases.
